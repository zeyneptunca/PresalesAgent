...
DEFAULTS = {
    ...
    "size_bands": [[50, "S"], [150, "M"], [300, "L"], [1e18, "XL"]],
    "fixed_bases": {
        "S": {"PM_Base": 1, "BA_Base": 1, "Test_Base": 1, "UAT_Base": 1},
        "M": {"PM_Base": 2, "BA_Base": 2, "Test_Base": 2, "UAT_Base": 2},
        "L": {"PM_Base": 3, "BA_Base": 3, "Test_Base": 3, "UAT_Base": 3},
        "XL": {"PM_Base": 4, "BA_Base": 4, "Test_Base": 4, "UAT_Base": 4},
    },
    "global_formulas": {
        "A": {"pm_pct": 0.09, "tech_design_pct": 0.04, "deployment_pct": 0.03, "uat_pct": 0.20},
        "B": {"pm_pct": 0.07, "tech_design_pct": 0.02, "deployment_pct": 0.02, "uat_pct": 0.15},
        "C": {"pm_pct": 0.06, "tech_design_pct": 0.02, "deployment_pct": 0.02, "uat_pct": 0.15},
    },
    "min_max_ranges": {
    ...
    "oneframe_residual": {
        ...
        "C": {
            ...
            "OF-WORKFLOW": [0.0, 0.35], "OF-APIGW": [0.0, 0.21], "OF-SIGNAL": [0.10, 0.21],
            "OF-VALID": [0.0, 0.21], "OF-DATA": [0.0, 0.25], "OF-AUDIT": [0.0, 0.25],
            "OF-CACHE": [0.0, 0.15], "OF-SEARCH": [0.0, 0.25], "OF-MULTI": [0.0, 0.25],
            "OF-DASH": [0.10, 0.10], "OF-PROFILE": [0.10, 0.10], "OF-REPORT": [0.10, 0.15],
            "OF-NOTIF": [0.0, 0.25], "OF-HANGFIRE": [0.0, 0.15], "OF-DMS": [0.10, 0.15],
            "OF-FILE": [0.0, 0.15], "OF-CMS": [0.10, 0.15], "OF-CHATBOT": [0.10, 0.15],
            "OF-CRUD": [0.0, 0.15], "OF-UI": [0.10, 0.0], "OF-FORM": [0.10, 0.10],
            "OF-TABLE": [0.10, 0.10], "OF-MENU": [0.10, 0.10], "OF-UPLOAD": [0.10, 0.10],
            "OF-FAQ": [0.10, 0.10], "OF-I18N": [0.10, 0.10], "OF-ERR": [0.0, 0.10],
